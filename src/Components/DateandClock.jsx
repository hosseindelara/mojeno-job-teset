...
const DateandClock = () => {
    ...
    let arryTime = [
        ...
        {
            weeky: weekday[new Date().getDay() + 1 > 7 ? 1 : new Date().getDay() + 1],
            year: MiladotoShamsi()[0],
            month: MiladotoShamsi()[1],
            day: MiladotoShamsi()[2] + 1 === 32 ? 1 : MiladotoShamsi()[2] + 1
        },
        {
            weeky: weekday[new Date().getDay() + 2 > 7 ? 1 : new Date().getDay() + 2],
            year: MiladotoShamsi()[0],
            month: MiladotoShamsi()[1],
            day: MiladotoShamsi()[2] + 2 === 33 ? 2 : MiladotoShamsi()[2] + 2
        },
        {
            weeky: weekday[new Date().getDay() + 3 > 7 ? 1 : new Date().getDay() + 3],
            year: MiladotoShamsi()[0],
            month: MiladotoShamsi()[1],
            ...
            >
                ...
                <Modal.Body>
                    ...
                    <Button variant='link' className='text-secondary' >
                        <Calendar3 className="ml-2" size={16} />
                    مشاهد تقویم
                    </Button>
                    ...
                    <Button variant="success" onClick={handelSunbmitModal} className='p-3 mt-3 mb-2 boxItems' block>تایید زمان  <CheckCircle size={16} className='mr-3' /></Button>
